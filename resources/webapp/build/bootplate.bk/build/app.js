...
tag: "div",
content: "@copyright dinsy&powerm",
style: "font-size: 10px; color: lightgrey; text-align: center"
} ]
}, {
name: "menu",
classes: "main-menu",
...
name: " \u751f\u6d3b\u5e38\u8bc6",
classes: "icon-lightbulb"
}, {
name: " \u767b\u5f55\u7ba1\u7406",
classes: "icon-cogs"
} ],
create: function() {
this.inherited(arguments), this.$.repeater.setCount(this.time_table.length);
},
rendered: function() {
this.inherited(arguments);
var e = this.$.welcomeDiv.getBounds(), t = this.$.mainContent.getBounds().height - e.top - e.height - 10;
this.$.timeScroller.applyStyle("height", t + "px"), this.panel_width = this.$.mainPanel.getBounds().width, this.$.menu.applyStyle("width", this.panel_width / 2 + "px"), this.animator = new enyo.Animator({
duration: 300,
...
animatorStep: function(e) {
this.$.mainContent.applyStyle("left", parseInt(e.value - this.panel_width / 2) + "px"), this.$.menu.applyStyle("left", parseInt(e.value - this.panel_width / 2) + "px"), this.$.mainPanel.reflow();
},
animatorEnd: function() {
...
timeTable: function(e, t) {
redirectTo("index.html");
},
leaveMessage: function(e, t) {
redirectTo("leavemessage.html");
},
lifeTips: function(e, t) {
...
var n = t.index, r = t.item, i = this.time_table[n];
n == 4 && r.$.item.applyStyle("background-color", "rgb(228, 242, 243)"), n == 0 ? r.$.cityName.setContent(i.name + "(\u59cb\u53d1)") : n == this.time_table.length - 1 ? r.$.cityName.setContent(i.name + "(\u7ec8\u70b9\u7ad9)") : r.$.cityName.setContent(i.name), r.$.arriveTime.setContent(i.arrive_time + '&nbsp;<small class="arrive">\u5230</small>'), r.$.leaveTime.setContent(i.leave_time + '&nbsp;<small class="leave">\u5f00</small>');
}
});
...
tag: "h2",
name: "articleTitle",
style: "padding: 10px 15px 0 15px;font-size: 18px;"
}, {
tag: "small",
name: "pubTime",
...
name: "articleContent",
allowHtml: !0,
style: "padding: 5px 15px;font-size: 15px;"
} ]
} ]
} ]
}, {
...
article: {
title: "\u4e9a\u9a6c\u900a\u4e2d\u56fd\u4f4e\u8c03\u4e0a\u7ebf\u5e94\u7528\u5546\u5e97",
createdTime: "2013-05-01 12:12",
content: "<p>\u65b0\u6d6a\u79d1\u6280\u8baf 5\u67084\u65e5\u4e0b\u5348\u6d88\u606f\uff0c\u4e9a\u9a6c\u900a\u4e2d\u56fd\u7f51\u7ad9z.cn\u4f4e\u8c03\u5728\u91cd\u8981\u4f4d\u7f6e\u63a8\u51fa\u5e94\u7528\u5546\u5e97\uff0c\u7528\u6237\u5b89\u88c5\u8be5\u5e94\u7528\u5546\u5e97\u540e\uff0c\u53ef\u4ee5\u4e0b\u8f7d\u5404\u7c7b\u6e38\u620f\u53ca\u76f8\u5173\u5f15\u7528\u3002<p>\u4e9a\u9a6c\u900a\u4e2d\u56fd\u5e94\u7528\u5546\u5e97\u4ecb\u7ecd\u663e\u793a\uff0c\u76ee\u524d\u5176\u652f\u6301\u88c5\u8f7dAndroid 2.2\u4ee5\u53ca\u66f4\u9ad8\u7248\u672c\u64cd\u4f5c\u7cfb\u7edf\u7684\u667a\u80fd\u624b\u673a\u548c\u5e73\u677f\u7535\u8111\u3002<p>\u5728\u4e9a\u9a6c\u900a\u5e94\u7528\u5546\u5e97\u91cc\uff0c\u4e0d\u4ec5\u6709\u817e\u8baf\u3001\u65b0\u6d6a\u548cImangi Studio \u7b49\u7545\u9500\u5f00\u53d1\u8005\u7684\u6700\u70ed\u95e8\u5e94\u7528\u548c\u6e38\u620f\uff0c\u4e5f\u5305\u542b Fryer Games\u548c\u795e\u5947\u65f6\u4ee3\u7b49\u6e38\u620f\u548c\u5e94\u7528\u5f00\u53d1\u8005\u7684\u7cbe\u54c1\u3002<p>\u6b64\u5916\uff0c\u4e9a\u9a6c\u900a\u4e2d\u56fd\u8fd8\u516c\u5e03\u4e86\u79fb\u52a8\u5e94\u7528\u7a0b\u5e8f\u9500\u552e\u8ba1\u5212\uff0c\u8be5\u8ba1\u5212\u663e\u793a\u4e9a\u9a6c\u900a\u5411\u5f00\u53d1\u8005\u652f\u4ed8\u6240\u6709\u9500\u552e\u5e02\u573a\u6807\u4ef7\u768470%\uff0c\u540c\u65f6\u5728\u4e2d\u56fd\u4e9a\u9a6c\u900a\u5c06\u514d\u9664\u5f00\u53d1\u8005\u8ba1\u521299\u7f8e\u5143\u7684\u5e74\u8d39\uff0c\u8be5\u5e74\u8d39\u670d\u52a1\u6db5\u76d6\u79fb\u52a8\u5e94\u7528\u7a0b\u5e8f\u9500\u552e\u8ba1\u5212\u7684\u5e94\u7528\u7a0b\u5e8f\u5904\u7406\u548c\u8d26\u6237\u7ba1\u7406\u3002<p>\u76ee\u524d\u4e9a\u9a6c\u900a\u5e94\u7528\u5546\u5e97\u5f53\u524d\u5df2\u5728\u7f8e\u56fd\u3001\u6cd5\u56fd\u3001\u5fb7\u56fd\u3001\u610f\u5927\u5229\u3001\u897f\u73ed\u7259\u3001\u82f1\u56fd\u548c\u65e5\u672c\u4e0a\u7ebf\u3002<p>\u8fd9\u4e9b\u4e3e\u52a8\u610f\u5473\u7740\u4e9a\u9a6c\u900a\u6b63\u5728\u52a0\u5927\u4e2d\u56fd\u5e03\u5c40\u529b\u5ea6\uff0c\u53bb\u5e74\u5e95\u4e9a\u9a6c\u900aKindle\u5546\u5e97\u6b63\u5f0f\u8fdb\u5165\u4e2d\u56fd\uff0c\u4e0d\u4e45\u524d\u4f4e\u8c03\u4e0a\u7ebf\u4e2a\u4eba\u4e91\u5b58\u50a8\u670d\u52a1Cloud Drive\uff0c\u8fd1\u671fKindle\u5165\u534e\u4f20\u95fb\u518d\u8d77\uff0c\u800c\u5e94\u7528\u5546\u5e97\u4e0eKindle\u5173\u7cfb\u5bc6\u5207\uff0c\u610f\u5473\u7740Kindle\u8fdb\u5165\u53ef\u80fd\u5f88\u5feb\u843d\u5b9a\u3002<p>\u65b0\u6d6a\u79d1\u6280\u8baf 5\u67084\u65e5\u4e0b\u5348\u6d88\u606f\uff0c\u4e9a\u9a6c\u900a\u4e2d\u56fd\u7f51\u7ad9z.cn\u4f4e\u8c03\u5728\u91cd\u8981\u4f4d\u7f6e\u63a8\u51fa\u5e94\u7528\u5546\u5e97\uff0c\u7528\u6237\u5b89\u88c5\u8be5\u5e94\u7528\u5546\u5e97\u540e\uff0c\u53ef\u4ee5\u4e0b\u8f7d\u5404\u7c7b\u6e38\u620f\u53ca\u76f8\u5173\u5f15\u7528\u3002<p>\u4e9a\u9a6c\u900a\u4e2d\u56fd\u5e94\u7528\u5546\u5e97\u4ecb\u7ecd\u663e\u793a\uff0c\u76ee\u524d\u5176\u652f\u6301\u88c5\u8f7dAndroid 2.2\u4ee5\u53ca\u66f4\u9ad8\u7248\u672c\u64cd\u4f5c\u7cfb\u7edf\u7684\u667a\u80fd\u624b\u673a\u548c\u5e73\u677f\u7535\u8111\u3002<p>\u5728\u4e9a\u9a6c\u900a\u5e94\u7528\u5546\u5e97\u91cc\uff0c\u4e0d\u4ec5\u6709\u817e\u8baf\u3001\u65b0\u6d6a\u548cImangi Studio \u7b49\u7545\u9500\u5f00\u53d1\u8005\u7684\u6700\u70ed\u95e8\u5e94\u7528\u548c\u6e38\u620f\uff0c\u4e5f\u5305\u542b Fryer Games\u548c\u795e\u5947\u65f6\u4ee3\u7b49\u6e38\u620f\u548c\u5e94\u7528\u5f00\u53d1\u8005\u7684\u7cbe\u54c1\u3002<p>\u6b64\u5916\uff0c\u4e9a\u9a6c\u900a\u4e2d\u56fd\u8fd8\u516c\u5e03\u4e86\u79fb\u52a8\u5e94\u7528\u7a0b\u5e8f\u9500\u552e\u8ba1\u5212\uff0c\u8be5\u8ba1\u5212\u663e\u793a\u4e9a\u9a6c\u900a\u5411\u5f00\u53d1\u8005\u652f\u4ed8\u6240\u6709\u9500\u552e\u5e02\u573a\u6807\u4ef7\u768470%\uff0c\u540c\u65f6\u5728\u4e2d\u56fd\u4e9a\u9a6c\u900a\u5c06\u514d\u9664\u5f00\u53d1\u8005\u8ba1\u521299\u7f8e\u5143\u7684\u5e74\u8d39\uff0c\u8be5\u5e74\u8d39\u670d\u52a1\u6db5\u76d6\u79fb\u52a8\u5e94\u7528\u7a0b\u5e8f\u9500\u552e\u8ba1\u5212\u7684\u5e94\u7528\u7a0b\u5e8f\u5904\u7406\u548c\u8d26\u6237\u7ba1\u7406\u3002<p>\u76ee\u524d\u4e9a\u9a6c\u900a\u5e94\u7528\u5546\u5e97\u5f53\u524d\u5df2\u5728\u7f8e\u56fd\u3001\u6cd5\u56fd\u3001\u5fb7\u56fd\u3001\u610f\u5927\u5229\u3001\u897f\u73ed\u7259\u3001\u82f1\u56fd\u548c\u65e5\u672c\u4e0a\u7ebf\u3002"
},
create: function() {
this.inherited(arguments);
},
...
this.$.articleScroller.applyStyle("height", e + "px"), this.panelWidth = this.$.mainPanel.getBounds().width, this.$.menu.applyStyle("width", this.panelWidth / 2 + "px"), this.$.articleTitle.setContent(this.article.title), this.$.pubTime.setContent(this.article.createdTime), this.$.articleContent.setContent(this.article.content), this.animator = new enyo.Animator({
duration: 300,
startValue: this.$.mainPanel.getBounds().width / 2,
endValue: 0,
node: this.$.mainContent.hasNode() && this.$.menu.hasNode(),
...
animatorStep: function(e) {
this.$.mainContent.applyStyle("left", parseInt(e.value - this.panelWidth / 2) + "px"), this.$.menu.applyStyle("left", parseInt(e.value - this.panelWidth / 2) + "px"), this.$.mainPanel.reflow();
},
animatorEnd: function() {
this.animator.reverse();
},
...
message: {
createdAt: "2013-05-01 12:12",
author: "\u5c0f\u674e",
message: "\u6700\u8fd1\u706b\u8f66\u7ad9\u7684\u70ed\u6c34\u4f9b\u5e94\u6709\u70b9\u4e0d\u53ca\u65f6,\u8bf7\u5217\u8f66\u957f\u5904\u7406",
commentNum: 5,
upNum: 12,
url: "/message/1",
comments: [ {
...
rendered: function() {
this.inherited(arguments);
var e = this.$.mainContent.getBounds().height - this.$.messageScroller.getBounds().top;
this.$.messageScroller.applyStyle("height", e + "px"), this.panelWidth = this.$.mainPanel.getBounds().width, this.$.menu.applyStyle("width", this.panelWidth / 2 + "px"), this.$.messageAuthor.setContent(this.message.author), this.$.msgCreatedAt.setContent("@" + this.message.createdAt), this.$.messageContent.setContent(this.message.message), this.animator = new enyo.Animator({
duration: 300,
startValue: this.$.mainPanel.getBounds().width / 2,
endValue: 0,
node: this.$.mainContent.hasNode() && this.$.menu.hasNode(),
...
i.$.commentAuthor.setContent(r.author), i.$.commentTime.setContent("@" + r.createdAt), i.$.commentContent.setContent('@<span class="enyo-blue">' + r.refer + ": </span>&nbsp;" + r.content), n % 2 == 0 && i.$.commentWrapper.addClass("odd-comment");
}
});
...
name: "wrapper",
kind: "FittableRows",
style: "padding: 0 5px 2px 5px;background-color: white;",
fit: !0,
components: [ {
name: "articleList",
kind: "List",
...
name: "articleTitle",
classes: "",
style: "font-size: 14px;hieght:17px;color:grey;"
}, {
tag: "div",
name: "articleOverview",
style: "font-size: 12px;height: 30px;color: #2f3e46;;padding: 5px 5px 5px 0;"
} ]
} ]
} ]
} ]
...
articles: [ {
title: "\u706b\u8f66\u5317\u7ad9\u91cd\u5927\u8c03\u6574",
overview: "\u6700\u8fd1\u706b\u8f66\u7ad9\u6b63\u5728\u8fdb\u884c\u5168\u9762\u6574\u6cbb,\u8bf7\u5404\u4f4d\u65c5\u5ba2\u8ba4\u771f\u914d\u5408.\u897f\u5b89\u5929\u6c14\u51c9\u723d,\u8bf7\u60a8\u6ce8\u610f\u9632\u5bd2\u4fdd\u6696",
url: "/article/1"
}, {
title: "\u5929\u6c14\u964d\u6e29,\u6ce8\u610f\u9632\u5bd2",
overview: "\u6700\u8fd1\u706b\u8f66\u7ad9\u6b63\u5728\u8fdb\u884c\u5168\u9762\u6574\u6cbb,\u8bf7\u5404\u4f4d\u65c5\u5ba2\u8ba4\u771f\u914d\u5408.\u897f\u5b89\u5929\u6c14\u51c9\u723d,\u8bf7\u60a8\u6ce8\u610f\u9632\u5bd2\u4fdd\u6696",
...
this.$.wrapper.applyStyle("height", e + "px"), this.panelWidth = this.$.mainPanel.getBounds().width, this.$.menu.applyStyle("width", this.panelWidth / 2 + "px"), this.animator = new enyo.Animator({
duration: 300,
startValue: this.$.mainPanel.getBounds().width / 2,
endValue: 0,
node: this.$.mainContent.hasNode() && this.$.menu.hasNode(),
...
this.$.articleImage.setSrc("/assets/1.jpg"), this.$.articleTitle.setContent(r.title), this.$.articleOverview.setContent(r.overview.slice(0, 50));
}
});
...
seats: {
capacity: 36,
occupied: [ 3, 6, 12, 15, 20, 34, 36 ],
changing: [ 1, 2, 5, 9, 14, 21, 24, 30, 31, 32 ]
},
create: function() {
this.inherited(arguments), this.$.seatRepeater.setCount(parseInt(this.seats.capacity / 3));
},
rendered: function() {
this.inherited(arguments);
var e = this.$.mainContent.getBounds().height - this.$.seatScroller.getBounds().top - 5;
this.$.seatScroller.applyStyle("height", e + "px"), this.panelWidth = this.$.mainPanel.getBounds().width, this.$.menu.applyStyle("width", this.panelWidth / 2 + "px"), this.animator = new enyo.Animator({
duration: 300,
startValue: this.$.mainPanel.getBounds().width / 2,
endValue: 0,
node: this.$.mainContent.hasNode() && this.$.menu.hasNode(),
...
var n = t.index, r = n * 3, s = t.item, o = [ r + 1, r + 2, r + 3 ], u;
for (i = 0; i < 3; i++) u = s.$["seat" + (i + 1)], u.setContent(o[i]), this.seats.occupied.indexOf(o[i]) != -1 ? (u.applyStyle("background-color", "red"), u.setProperty("status", "occupied")) : this.seats.changing.indexOf(o[i]) != -1 ? (u.applyStyle("background-color", "yellow"), u.setProperty("status", "changing")) : (u.applyStyle("background-color", "white"), u.setProperty("status", "idle"));
},
...
content: "\u63d0\u4ea4",
style: "float: right;",
classes: "onyx-dark  icon-shopping-cart"
} ]
}, {
name: "wrapper",
...
classes: "combo-table-item"
}, {
tag: "span",
name: "comboPrice",
style: "width:30%;text-align: right;font-size: 12px; ",
classes: "combo-table-item"
}, {
kind: "onyx.Button",
name: "buyButton",
...
classes: "combo-table-item onyx-affirmative",
ontap: "buyCombo",
popup: "itemPopup"
} ]
}, {
tag: "div",
name: "comboDetail",
style: "display: none; border-top: solid 1px lightgrey;padding: 5px 15px;background-color: rgb(224, 231, 222);",
allowHtml: !0,
components: []
} ]
} ]
...
rendered: function() {
this.inherited(arguments), this.panel_width = this.$.mainPanel.getBounds().width, this.$.menu.applyStyle("width", this.panel_width / 2 + "px");
var e = this.$.mainContent.getBounds().height - this.$.orderScroller.getBounds().top - 10;
this.$.orderScroller.applyStyle("height", e + "px"), this.animator = new enyo.Animator({
duration: 300,
startValue: this.$.mainPanel.getBounds().width / 2,
endValue: 0,
node: this.$.mainContent.hasNode() && this.$.menu.hasNode(),
...
var n = t.index, r = e.parent.children[1], i = r.getContent().match(/(\d+\u5143)$/)[1];
...
var n = this.comboIndex, r = e.parent.children[0].children[0];
if (r.getValue() != "") {
this.combos[n].num = parseInt(r.getValue());
var i = n == 0 ? "" : n + 1, s = this.$.comboRepeater.$["ownerProxy" + i].$.comboPrice, o = s.getContent().match(/(\d+\u5143)$/)[1];
...
i.setContent(this.combos[n].price + "\u5143"), s.setContent("\u8d2d\u4e70"), this.combos[n].num = 0, e.parent.hide();
},
changeGoodsItemNum: function(e, t) {
var n = this.goodsIndex, r = e.parent.children[0].children[0];
if (r.getValue() != "") {
this.goods[n].num = parseInt(r.getValue());
var i = n == 0 ? "" : n + 1, s = this.$.goodsRepeater.$["ownerProxy" + i].$.goodsPrice, o = s.getContent().match(/(\d+\u5143)$/)[1];
s.setContent(r.getValue() + " x " + o);
}
e.parent.hide();
},
...
i.setContent(this.goods[n].price + "\u5143"), s.setContent("\u8d2d\u4e70"), this.goods[n].num = 0, e.parent.hide();
},
...
trainInfo: {
mainInfo: [ [ "id", 12 ], [ "\u8f66\u6b21", "K878" ], [ "\u5217\u8f66\u957f", "\u738b\u5c0f" ], [ "\u9910\u8f66\u7bb1\u53f7", 12 ], [ "\u603b\u8f66\u53a2\u6570", 20 ], [ "\u59cb\u53d1\u7ad9", "\u897f\u5b89" ], [ "\u7ec8\u70b9\u7ad9", "\u682a\u6d32" ] ],
extraInfo: [ [ "\u4e58\u52a1\u5458\u6570\u91cf", 50 ], [ "\u53a8\u5e08\u6570\u91cf", 3 ], [ "\u63a8\u9500\u5458\u6570\u91cf", 5 ] ]
},
create: function() {
...
rendered: function() {
this.inherited(arguments);
var e = this.$.mainContent.getBounds().height - this.$.infoScroller.getBounds().top;
this.$.infoScroller.applyStyle("height", e + "px"), this.panelWidth = this.$.mainPanel.getBounds().width, this.$.menu.applyStyle("width", this.panelWidth / 2 + "px"), this.animator = new enyo.Animator({
duration: 300,
startValue: this.$.mainPanel.getBounds().width / 2,
endValue: 0,
node: this.$.mainContent.hasNode() && this.$.menu.hasNode(),
