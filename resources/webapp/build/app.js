...
create: function() {
this.inherited(arguments), this.$.msgRepeater.setCount(AppData.msg.length);
var e = enyo.getCookie("is_notice_shown");
if (!e || e != "true") this.$.noticeRepeater.setCount(AppData.notice.length), enyo.setCookie("is_notice_shown", "true", {
expires: 1
});
},
rendered: function() {
...
var t = this.$.noticeWrapper;
t.applyStyle("left", (t.parent.getBounds().width - t.getBounds().width) / 2 + "px"), setTimeout(enyo.bind(this, this.timeout), 5e3);
},
animatorStep: function(e) {
this.$.mainContent.applyStyle("left", parseInt(e.value - this.panelWidth / this.divide) + "px"), this.$.menu.applyStyle("left", parseInt(e.value - this.panelWidth / this.divide) + "px"), this.$.mainPanel.reflow();
},
animatorEnd: function() {
...
r.$.msgContent.setContent(i);
},
setupNoticeItem: function(e, t) {
var n = t.index, r = t.item, i = AppData.notice[n];
...
components: [ {
kind: "onyx.Toolbar",
name: "rightMenuToolbar",
style: "padding-right: 0;height: 36px;",
components: [ {
kind: "onyx.Button",
name: "returnIcon",
style: "float:left;border: none;background:none;outline;box-shadow:none",
classes: "icon-angle-left",
ontap: "showMenu"
}, {
kind: "onyx.Button",
name: "menuListIcon",
style: "float: right; border: none;background:none;outline;box-shadow:none;",
content: "\u5217\u8868",
...
components: [ {
tag: "div",
classes: "icon-table menu-list-item",
content: "\u5217\u8f66\u65f6\u523b\u8868(\u9996\u9875)",
ontap: "toHome"
}, {
tag: "div",
style: "margin-top: 1px;",
classes: "icon-food menu-list-item",
content: "\u70b9\u9910",
ontap: "toOrder"
}, {
tag: "div",
classes: "icon-edit menu-list-item",
content: "\u7559\u8a00",
ontap: "toMessage"
}, {
tag: "div",
...
kind: "Repeater",
name: "msgRepeater",
onSetupItem: "setupMsgItem",
components: [ {
tag: "div",
classes: "notice-row",
style: "background-color: #68af02;",
components: [ {
tag: "label",
classes: "icon-quote-left"
}, {
tag: "span",
name: "msgContent",
classes: "",
...
style: "display: inline-block; float: right;padding: 3px;",
content: "\u5173\u95ed",
ontap: "closeMsg"
} ]
} ]
...
name: "cityName",
allowHtml: !0,
classes: "time-table-item toy-orange"
} ]
}, {
tag: "span",
allowHtml: !0,
...
create: function() {
this.inherited(arguments), this.$.repeater.setCount(this.timeTable.length);
},
rendered: function() {
this.inherited(arguments);
},
setupItem: function(e, t) {
var n = t.index, r = t.item, i = this.timeTable[n];
n == 4 && r.$.item.applyStyle("background-color", "rgb(228, 242, 243)"), n == 0 ? r.$.cityName.setContent(i.city_name + "(\u59cb\u53d1)") : n == this.timeTable.length - 1 ? r.$.cityName.setContent(i.city_name + "(\u7ec8\u70b9\u7ad9)") : r.$.cityName.setContent(i.city_name), r.$.arriveTime.setContent(i.arrive_time + '&nbsp;<small class="arrive">\u5230</small>'), r.$.leaveTime.setContent(i.leave_time + '&nbsp;<small class="leave">\u5f00</small>');
}
});
...
name: "wrapper",
style: "background-color: rgb(248, 247, 245);",
components: [ App.noticeComponents, {
kind: "Scroller",
...
tag: "h2",
name: "articleTitle",
style: "padding: 10px 5px 0 5px;font-size: 18px;"
}, {
tag: "small",
name: "pubTime",
...
tag: "hr",
style: "border:none;border-top:dashed 1px lightgrey;height: 0;"
}, {
tag: "div",
name: "articleContent",
allowHtml: !0,
style: "padding: 5px 5px;font-size: 15px;"
} ]
}, {
tag: "div",
name: "commentsWrapper",
components: [ {
name: "commentRepeater",
onSetupItem: "setupComments",
kind: "Repeater",
components: [ {
name: "commentWrapper",
...
tag: "span",
name: "commentAuthor",
style: "font-size: 14px;font-size: bold;"
}, {
tag: "small",
content: "\u8bc4\u8bba",
...
create: function() {
this.inherited(arguments), this.$.commentRepeater.setCount(this.comments.length);
},
rendered: function() {
this.inherited(arguments);
var e = this.$.mainContent.getBounds().height - this.$.articleScroller.getBounds().top;
this.$.articleScroller.applyStyle("height", e + "px"), this.$.articleTitle.setContent(this.article.title), this.$.pubTime.setContent(this.article.created_at), this.$.articleContent.setContent(this.article.content);
},
setupComments: function(e, t) {
var n = t.index, r = this.comments[n], i = t.item;
i.$.commentAuthor.setContent(r.author), i.$.commentTime.setContent("@" + r.createdAt), i.$.commentContent.setContent('@<span class="enyo-blue">' + r.refer + ": </span>&nbsp;" + r.content), n % 2 == 0 && i.$.commentWrapper.applyStyle("background-color", "white");
}
});
...
components: [ {
tag: "div",
style: "width:0; height:0;border:5px solid #b50; border-color:transparent transparent #b50 transparent;margin:-2px 0 -1px 5px;"
}, {
tag: "div",
name: "messageContent",
allowHtml: !0,
style: "border: solid 1px #b50; min-height: 50px;padding: 5px 2px;font-size: 14px;"
} ]
} ]
}, {
tag: "div",
...
name: "commentBody",
style: "position: relative",
classes: "comment-body odd-comment",
components: [ {
tag: "div",
classes: "comment-row",
components: [ {
...
create: function() {
this.inherited(arguments), this.$.commentRepeater.setCount(this.message.comments.length);
},
rendered: function() {
this.inherited(arguments);
var e = this.message.message;
this.$.messageAuthor.setContent(e.name), this.$.msgCreatedAt.setContent("@" + e.created_at), this.$.messageContent.setContent(e.content), window.c = this.$.commentTextarea;
},
setupComments: function(e, t) {
var n = t.index, r = this.message.comments[n], i = t.item;
i.$.commentAuthor.setContent(r.name), i.$.commentTime.setContent("@" + r.created_at), i.$.commentContent.setContent('@<span class="enyo-blue">' + r.refer_to + ": </span>&nbsp;" + r.content), n % 2 == 0 && i.$.commentWrapper.addClass("odd-comment");
},
...
s[AppData.csrf_token_name] = AppData.csrf_hash;
var o = new enyo.Ajax({
...
o.response(this, "processResponse"), o.error(this, "processError"), o.go();
},
processResponse: function(e, t) {
t.code == 0 ? location.reload() : console.log("submit comment failed.");
},
...
name: "wrapper",
kind: "FittableRows",
style: "padding: 0 5px 2px 5px;background-color: rgb(245, 245, 245);",
fit: !0,
components: [ App.noticeComponents, {
name: "articleList",
kind: "List",
...
fixedHeight: !0,
noSelect: !0,
onSetupItem: "setupArticleItem",
classes: "enyo-unselectable",
components: [ {
name: "articleItem",
classes: "article-item",
ontap: "toArticle",
style: "padding: 5px; clear: both;height: 70px;margin-top: 5px;border-radius: 0px;overflow:hidden",
components: [ {
tag: "img",
name: "articleImage",
...
create: function() {
this.inherited(arguments), this.$.articleList.setCount(this.articles.length);
},
rendered: function() {
this.inherited(arguments);
var e = this.$.mainContent.getBounds().height - this.$.wrapper.getBounds().top;
...
var n = t.index, r = this.articles[n];
this.$.articleImage.setSrc("/resources/webapp/assets/1.jpg"), this.$.articleTitle.setContent(r.title), this.$.articleOverview.setContent(r.content.slice(0, 100));
}
});
...
content: "\u786e\u5b9a",
style: "float: right;",
classes: "icon-circle-blank icon- onyx-dark",
ontap: "submitSeat"
} ]
}, {
name: "wrapper",
kind: "FittableRows",
fit: !0,
style: "padding: 0  5px 5px 5px;background-color: rgb(245, 245, 245);",
components: [ App.noticeComponents, {
kind: "Scroller",
name: "seatScroller",
fit: !0,
...
fixedHeight: !0,
noSelect: !0,
onSetupItem: "setupSeatItem",
classes: "enyo-unselectable",
components: [ {
name: "seatItem",
classes: "seat-item",
style: "clear: both;margin-top: 5px;overflow:hidden",
components: [ {
tag: "span",
style: "width: 32%",
components: [ {
...
create: function() {
this.inherited(arguments), this.$.seatRepeater.setCount(parseInt(this.seatCapacity / 3 + 1));
},
rendered: function() {
this.inherited(arguments);
},
setupSeatItem: function(e, t) {
var n = t.index, r = n * 3, s = t.item, o = [ r + 1, r + 2, r + 3 ], u, a = 0;
for (i = 0; i < 3 && a < this.seatCapacity; i++, a++) u = s.$["seat" + (i + 1)], u.setContent(o[i]), this.seats["occupied"].indexOf(o[i]) != -1 ? (u.applyStyle("background-color", "red"), u.setProperty("status", "occupied")) : this.seats["changing"].indexOf(o[i]) != -1 ? (u.applyStyle("background-color", "yellow"), u.setProperty("status", "changing")) : (u.applyStyle("background-color", "white"), u.setProperty("status", "idle"));
},
changeSeatStatus: function(e, t) {
var n = t.index, r = parseInt(e.getContent());
switch (e.getProperty("status")) {
case "occupied":
e.applyStyle("background-color", "white"), this.seats.occupied.splice(this.seats.occupied.indexOf(r), 1), e.setProperty("status", "idle");
break;
case "changing":
e.applyStyle("background-color", "red"), this.seats.changing.splice(this.seats.changing.indexOf(r), 1), e.setProperty("status", "occupied"), this.seats.occupied.push(r);
break;
case "idle":
e.applyStyle("background-color", "yellow"), this.seats.changing.push(r), e.setProperty("status", "changing");
}
return !0;
},
...
n[AppData.csrf_token_name] = AppData.csrf_hash;
var r = new enyo.Ajax({
...
r.response(this, "processSubmit"), r.error(this, "errorSubmit"), r.go();
},
processSubmit: function(e, t) {
t.code == 0 && (location.reload(), console.log("submit seat status succed!"));
},
...
content: "\u786e\u5b9a",
style: "float: right;",
classes: "onyx-dark  icon-circle-blank",
ontap: "showMenu"
} ]
}, {
name: "wrapper",
...
tag: "span",
name: "comboName",
classes: "order-row-left"
}, {
tag: "div",
classes: "order-row-right",
components: [ {
tag: "span",
name: "comboPrice",
classes: "price-label"
...
name: "buyButton",
content: "\u8d2d\u4e70",
classes: "order-buy-button onyx-affirmative",
ontap: "buyCombo",
popup: "itemPopup"
} ]
} ]
...
tag: "div",
name: "comboDetail",
classes: "order-row odd-comment",
style: "display: none;height: auto; padding: 10px;",
allowHtml: !0,
components: []
} ]
} ]
...
classes: "onyx-affirmative",
content: "\u786e\u5b9a",
ontap: "changeGoodsItemNum"
}, {
kind: "onyx.Button",
classes: "onyx-negative",
content: "\u5220\u9664",
ontap: "deleteGoodsItem"
} ]
} ]
} ]
} ]
...
components: [ {
kind: "onyx.Groupbox",
classes: "userinfo-groupbox",
components: [ {
kind: "onyx.GroupboxHeader",
content: "\u7528\u6237\u4fe1\u606f"
}, {
tag: "div",
classes: "userinfo-row",
components: [ {
tag: "div",
content: "\u7528\u6237\u79f0\u547c",
classes: "userinfo-left"
}, {
kind: "onyx.InputDecorator",
classes: "userinfo-right",
alwaysLooksFocused: !0,
components: [ {
kind: "onyx.Input",
name: "userNameInput",
...
style: "width: 100%; text-align: right;color: rgb(197, 22, 22);",
value: "\uffe51",
disabled: !0
} ]
} ]
...
create: function() {
this.inherited(arguments), this.$.comboRepeater.setCount(this.combos.length), this.$.goodsRepeater.setCount(this.goods.length);
},
rendered: function() {
this.inherited(arguments);
},
setupComboItem: function(e, t) {
var n = t.index, r = t.item, s = this.combos[n];
r.$.comboName.setContent(s.name), r.$.comboPrice.setContent(s.price + "\u5143");
var o = "\u5957\u9910\u5305\u542b:<br />";
for (i = 0; i < s.goods.length; ++i) o += s.goods[i] + " ";
r.$.comboDetail.setContent(o);
},
setupGoodsItem: function(e, t) {
var n = t.index, r = t.item, i = this.goods[n];
r.$.goodsName.setContent(i.name), r.$.goodsPrice.setContent(i.price + "\u5143");
},
showDetails: function(e, t) {
var n = e.parent.children[1];
n.getComputedStyleValue("display") == "none" ? n.applyStyle("display", "block") : n.applyStyle("display", "none");
},
buyCombo: function(e, t) {
var n = t.index, r = e.parent.children[0], i = r.getContent().match(/([\d]+[.][\d]+\u5143)$/)[1];
return e.getContent().match(/\u8d2d\u4e70/) ? (e.setContent("\u7f16\u8f91"), r.setContent("1 x " + i), this.combos[n].num = 1) : (this.comboIndex = n, this.$[e.popup].show(), this.$[e.popup].children[0].children[0].setValue(this.combos[n].num)), !0;
},
buyGoods: function(e, t) {
var n = t.index, r = e.parent.children[0], i = r.getContent().match(/([\d]+[.][\d]+\u5143)$/)[1];
return e.getContent().match(/\u8d2d\u4e70/) ? (e.setContent("\u7f16\u8f91"), r.setContent("1 x " + i), this.goods[n].num = 1) : (this.goodsIndex = n, this.$[e.popup].show(), this.$[e.popup].children[0].children[0].setValue(this.goods[n].num)), !0;
},
changeItemNum: function(e, t) {
var n = this.comboIndex, r = e.parent.parent.children[0].children[0];
if (r.getValue() != "") {
this.combos[n].num = parseInt(r.getValue());
var i = n == 0 ? "" : n + 1, s = this.$.comboRepeater.$["ownerProxy" + i].$.comboPrice, o = s.getContent().match(/([\d]+[.][\d]+\u5143)$/)[1];
s.setContent(r.getValue() + " x " + o);
}
e.parent.parent.hide();
},
deleteItem: function(e, t) {
var n = this.comboIndex, r = n == 0 ? "" : n + 1, i = this.$.comboRepeater.$["ownerProxy" + r].$.comboPrice, s = this.$.comboRepeater.$["ownerProxy" + r].$.buyButton;
i.setContent(this.combos[n].price + "\u5143"), s.setContent("\u8d2d\u4e70"), this.combos[n].num = 0, e.parent.parent.hide();
},
changeGoodsItemNum: function(e, t) {
var n = this.goodsIndex, r = e.parent.parent.children[0].children[0];
if (r.getValue() != "") {
this.goods[n].num = parseInt(r.getValue());
var i = n == 0 ? "" : n + 1, s = this.$.goodsRepeater.$["ownerProxy" + i].$.goodsPrice, o = s.getContent().match(/([\d]+[.][\d]+\u5143)$/)[1];
s.setContent(r.getValue() + " x " + o);
}
e.parent.parent.hide();
},
deleteGoodsItem: function(e, t) {
var n = this.goodsIndex, r = n == 0 ? "" : n + 1, i = this.$.goodsRepeater.$["ownerProxy" + r].$.goodsPrice, s = this.$.goodsRepeater.$["ownerProxy" + r].$.buyButton;
i.setContent(this.goods[n].price + "\u5143"), s.setContent("\u8d2d\u4e70"), this.goods[n].num = 0, e.parent.parent.hide();
},
hideCombo: function(e, t) {
var n = e.parent.children[1];
n.getComputedStyleValue("display") == "none" ? n.applyStyle("display", "block") : n.applyStyle("display", "none");
},
fillUserInfo: function(e, t) {
var n = this.$.wrapper.createComponent({
style: "height: 100%",
components: [ {
tag: "div",
content: "test"
...
var e = 0;
for (c in this.combos) this.combos[c].num && (e += (this.combos[c].num || 0) * parseFloat(this.combos[c].price), this.comboInOrder.push([ parseInt(this.combos[c].combo_id), this.combos[c].num ]));
for (g in this.goods) this.goods[g].num && (e += (this.goods[g].num || 0) * parseFloat(this.goods[g].price), this.goodsInOrder.push([ parseInt(this.goods[g].goods_id), this.goods[g].num ]));
return this.totalPrice = e, e;
},
showMenu: function(e, t) {
this.inherited(arguments), this.$.totalPriceInput.setValue("\uffe5" + this._totalPrice());
},
confirmOrder: function(e, t) {
if (this.totalPrice <= 0) {
console.log("no item selected:)");
return;
}
var n = [ "userNameInput", "carriageSerialInput", "seatNumInput" ];
for (i in n) if (!this.$[n[i]].getValue()) {
...
r[AppData.csrf_token_name] = AppData.csrf_hash;
var s = new enyo.Ajax({
...
trainInfo: {
mainInfo: [ [ "id", AppData.train_info && AppData.train_info.train_id ], [ "\u8f66\u6b21", AppData.train_info && AppData.train_info.serial ] ],
extraInfo: AppData.train_info && AppData.train_info.extra_info
},
create: function() {
this.inherited(arguments), this.$.mainRepeater.setCount(this.trainInfo.mainInfo.length), this.$.extraRepeater.setCount(this.trainInfo.extraInfo.length);
},
rendered: function() {
this.inherited(arguments);
},
setMainInfo: function(e, t) {
var n = t.index, r = t.item, i = this.trainInfo.mainInfo[n];
r.$.infoField.setContent(i[0]), r.$.infoValue.setContent(i[1]);
},
setExtraInfo: function(e, t) {
var n = t.index, r = t.item, i = this.trainInfo.extraInfo[n];
r.$.infoField.setContent(i[0]), r.$.infoValue.setContent(i[1]);
}
});
...
content: "\u7559\u8a00",
style: "float: right;",
classes: "icon-comment reorder onyx-dark",
ontap: "showMsgArea"
} ]
}, {
name: "commentBody",
...
classes: "comment-body odd-comment leave-message",
components: [ {
tag: "div",
classes: "comment-row",
components: [ {
...
name: "wrapper",
kind: "FittableRows",
style: "padding: 0 5px;background-color: rgb(245, 245, 245);",
fit: !0,
components: [ App.noticeComponents, {
name: "messageList",
kind: "List",
...
ontap: "toComment",
style: "font-size: 12px;padding: 5px; clear: both;margin-top: 5px;background-color: white;",
components: [ {
tag: "div",
name: "authorName",
...
create: function() {
this.inherited(arguments), this.$.messageList.setCount(this.messages.length);
},
rendered: function() {
this.inherited(arguments);
},
...
processResponse: function(e, t) {
t.code == 0 ? location.reload() : console.log("submit message failed.");
},
processError: function(e, t) {
...
components: [ {
tag: "div",
style: "width: 248px; margin: 0 auto;text-align: left",
components: [ {
tag: "div",
classes: "logo"
}, {
...
tag: "span",
style: "color: white; font-size: 14px;display: inline-block; padding: 5px;",
content: "\u4fdd\u5b58\u5bc6\u7801"
} ]
}, {
tag: "a",
style: "color: white; font-size: 14px;display: block; padding: 7px;float: right",
classes: "login-bottom",
content: "\u5fd8\u8bb0\u5bc6\u7801?"
} ]
} ]
} ]
...
rendered: function() {
this.inherited(arguments), this.panelWidth = this.$.mainPanel.getBounds().width;
var e = this.$.mainContent.getBounds().height - this.$.mainToolbar.getBounds().height;
this.$.wrapper.applyStyle("height", e + "px");
},
login: function(e, t) {
...
n[AppData.csrf_token_name] = AppData.csrf_hash, console.log(n);
var r = new enyo.Ajax({
...
r.response(this, "processResponse"), r.error(this, "processError"), r.go();
},
processResponse: function(e, t) {
t.code == 0 ? redirectTo(getUrlParams().url || "/mobile/") : console.log("error login");
},
processError: function(e, t) {
